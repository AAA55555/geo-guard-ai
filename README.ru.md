...
Alias в shell: /Users/me/.zshrc
  ✅ alias с твоими флагами: alias claude="geo-guard claude --dangerously-skip-permissions"
...
- оба hook-файла: есть ли там наша запись **и** пригоден ли файл для установки вообще — битый JSON в `settings.json` или строка вместо объекта в `hooks` попадут в отчёт строкой, а не упадут с ошибкой;
- блок alias в rc-файле: наш, наш с твоими флагами (это нормально) или чужое содержимое внутри наших маркеров (это уже не нормально);
