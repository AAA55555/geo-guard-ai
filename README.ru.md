...
6. в какой **shell** класть alias — определённый автоматически предлагается по умолчанию.
...
- блок alias в rc-файле: наш, наш с твоими флагами (это нормально), чужое содержимое внутри наших маркеров (это уже не нормально) — либо блок, у которого снесли маркер `# <<< geo-guard-ai end <<<`. Последнее сообщается как есть, с уточнением, какой из двух случаев: наш блок `setup` починит, а блок с твоим содержимым он не тронет и чинить придётся руками;
